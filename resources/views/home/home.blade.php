...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14">
        ...
        <!-- Dashboard Title -->
        <h1 class="text-2xl font-bold mb-4">Dashboard Arsip</h1>
        ...
        <!-- Chart Section -->
        <div class="bg-white p-4 rounded-lg shadow dark:bg-gray-800 mt-6">
            {!! $chartArsip->container() !!}
        </div>

        <div class="bg-white p-4 rounded-lg shadow dark:bg-gray-800 mt-6">
            <a href="{{ route('home.laporan') }}" class="mt-4 bg-green-500 text-white p-2 rounded">
                Unduh Laporan PDF
            </a>
        </div>
...
<script src="{{ $chartArsip->cdn() }}"></script>
{{ $chartArsip->script() }}
@endsection
